            ...
            <section className="bg-black text-white cursor-pointer pricingpage">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    ...
                    <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-0 p-8 lg:space-y-0">
                        ...
                        <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white -lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                            ...
                            <button className="pricingbtn bg-red-600 text-white font-semibold uppercase py-3 px-8">Get Started</button>
                        </div>
