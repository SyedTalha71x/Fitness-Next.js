        ...
        <div ref={ref}>
            <motion.div
                ...
                <div className="train_section_heading text-white text-center mt-5">
                    ...
                    <p className='w-full mt-2  text-xl'>Meet with our Professional certified Fitness Trainers.</p>
                        ...
                        <div className="train_row relative h-[40vh] w-full bg-black overflow-hidden m-3">
                            ...
                            <div className="train_content">
                                ...
                                <div className='mt-4'>
                                    ...
                                    <Link href={"/contact"} className="tran_btn text-white bg-black py-3 px-14 uppercase rounded-md">Hire Now</Link>
                                </div>
                            </div>
                        </div>
                        <div className="train_row relative h-[40vh] w-full bg-black overflow-hidden m-3">
